      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full h-11 pl-10 pr-4 rounded-xl border border-gray-200 bg-navy-800/50 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-inferra-500/20 focus:border-inferra-500"
          />
        </div>
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <select
              ...
              className="h-11 pl-9 pr-10 rounded-xl border border-gray-200 bg-navy-800/50 text-white appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-inferra-500/20 focus:border-inferra-500"
            >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-3 mb-1">
            <code className="text-xs bg-white/10 px-2 py-1 rounded font-mono text-gray-400">
        ...
        <div className="flex items-center gap-6 text-sm">
          ...
          <div className="text-right">
            <p className="font-medium text-gray-300">{request.processingTimeMs}ms</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-white/5 rounded-xl p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-500">Requires Reasoning</span>
                  <span className="font-medium">{request.characterization.requiresReasoning ? 'Yes' : 'No'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Contains Code</span>
            ...
            <div className="bg-white/5 rounded-xl p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className={`font-medium ${request.security.hasPII ? 'text-amber-400' : 'text-green-400'}`}>
                    {request.security.hasPII ? 'Yes' : 'No'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-500">Secrets Detected</span>
                  <span className={`font-medium ${request.security.hasSecrets ? 'text-red-400' : 'text-green-400'}`}>
            ...
            <div className="bg-white/5 rounded-xl p-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-500">Est. Latency</span>
